#############################################################################
##
##  CoCoA.gi               RingsForHomalg package         Mohamed Barakat
...
##
##  Implementation stuff for the external computer algebra system CoCoA.
##
#############################################################################
...
InstallValue( HOMALG_IO_CoCoA,
        rec(
            cas := "CoCoA",			## normalized name on which the user should have no control
            name := "CoCoA",
            executable := [ "CoCoA" ],	## this list is processed from left to right
            options := [ "-t", "--ticks-per-sec", "1000", "--echo=0", "--no-warn", "--cntrlc=a" ],	## the option "-q" causes IO to believe that CoCoA has died!
            BUFSIZE := 1024,
            READY := "!$%&/(",
            ...
            eoc_verbose := ";",
            eoc_quiet := ";",
            nolistlist := true,			## a CoCoA specific
            break_lists := true,		## a CoCoA specific
            handle_output := true,		## a CoCoA specific
#            original_lines := true,		## a CoCoA specific
            check_output := true,		## a CoCoA specific looks for newlines without commas
            setring := _CoCoA_SetRing,	## a CoCoA specific
            ## prints polynomials in a format compatible with other CASs
            setring_post := [ "short=0;", "option(redTail);" ],	## a CoCoA specific
            setinvol := _CoCoA_SetInvolution,## a CoCoA specific
            define := "=",
            delete := function( var, stream ) homalgSendBlocking( [ "kill ", var ], "need_command", stream, HOMALG_IO.Pictograms.delete ); end,
            multiple_delete := _CoCoA_multiple_delete,
            prompt := "\033[01mCoCoA>\033[0m ",
            output_prompt := "\033[1;30;43m<CoCoA\033[0m ",
            ...
            InitializeCASMacros := InitializeCoCoAMacros,
...
HOMALG_IO_CoCoA.READY_LENGTH := Length( HOMALG_IO_CoCoA.READY );
...
DeclareRepresentation( "IsHomalgExternalRingObjectInCoCoARep",
        IshomalgExternalRingObjectRep,
        [  ] );

# a new subrepresentation of the representation IsHomalgExternalRingRep:
DeclareRepresentation( "IsHomalgExternalRingInCoCoARep",
...
# a new type:
BindGlobal( "TheTypeHomalgExternalRingObjectInCoCoA",
        NewType( TheFamilyOfHomalgRings,
                IsHomalgExternalRingObjectInCoCoARep ) );

# a new type:
BindGlobal( "TheTypeHomalgExternalRingInCoCoA",
        NewType( TheFamilyOfHomalgRings,
                IsHomalgExternalRingInCoCoARep ) );
...
InstallGlobalFunction( _CoCoA_SetRing,
  function( R )
    local stream;
    
    stream := homalgStream( R );
    
    ## since _CoCoA_SetRing might be called from homalgSendBlocking,
    ...
    if IsBound( HOMALG_IO_CoCoA.setring_post ) then
        homalgSendBlocking( HOMALG_IO_CoCoA.setring_post, "need_command", stream, HOMALG_IO.Pictograms.initialize );
    fi;
...
##
InstallGlobalFunction( _CoCoA_SetInvolution,
  function( R )
    local RP;
...
##
InstallGlobalFunction( _CoCoA_multiple_delete,
...
{\n\
  ...
  for(int i=1; i<=ncols(M); i++){\n\
    for(int j=1; j<=nrows(M); j++){\n\
      def p=M[j,i]; // remark: matrices are saved transposed in CoCoA\n\
...
{\n\
  ...
  {\n\
    ...
    if ( b && i > 1 ) { if ( m[1,i] <> m[1,i-1] ) { b = 0; } } // CoCoA is strange\n\
  }\n\
...
{\n\
  ...
  {\n\
    ...
    if ( b && j > 1 ) { if ( m[1,j] <> m[1,j-1] ) { b = 0; } } // CoCoA is strange\n\
  }\n\
  if ( b ) { return(m[1,1]); } else { return(m); }\n\
}\n\n",
...
##  <#GAPDoc Label="BasisOfRowModule:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="BasisOfRowModule" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
...
##  <#GAPDoc Label="BasisOfColumnModule:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="BasisOfColumnModule" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="BasisOfRowsCoeff:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M, T" Name="BasisOfRowsCoeff" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="BasisOfColumnsCoeff:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M, T" Name="BasisOfColumnsCoeff" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="DecideZeroRows:CoCoAMacro">
##  <ManSection>
##    <Func Arg="A, B" Name="DecideZeroRows" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="DecideZeroColumns:CoCoAMacro">
##  <ManSection>
##    <Func Arg="A, B" Name="DecideZeroColumns" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="DecideZeroRowsEffectively:CoCoAMacro">
##  <ManSection>
##    <Func Arg="A, B, T" Name="DecideZeroRowsEffectively" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="DecideZeroColumnsEffectively:CoCoAMacro">
##  <ManSection>
##    <Func Arg="A, B, T" Name="DecideZeroColumnsEffectively" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="SyzygiesGeneratorsOfRows:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="SyzygiesGeneratorsOfRows" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="SyzygiesGeneratorsOfColumns:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="SyzygiesGeneratorsOfColumns" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="RelativeSyzygiesGeneratorsOfRows:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M, M2" Name="RelativeSyzygiesGeneratorsOfRows" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="RelativeSyzygiesGeneratorsOfColumns:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M, M2" Name="RelativeSyzygiesGeneratorsOfColumns" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="ReducedSyzygiesGeneratorsOfRows:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="ReducedSyzygiesGeneratorsOfRows" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
##  <#GAPDoc Label="ReducedSyzygiesGeneratorsOfColumns:CoCoAMacro">
##  <ManSection>
##    <Func Arg="M" Name="ReducedSyzygiesGeneratorsOfColumns" Label="CoCoA macro"/>
##    <Returns></Returns>
##    <Description>
##    
##      <Listing Type="Code"><![CDATA[
...
{\n\
  return(primdecSY(m))\n\
    ...
    Deg := "\n\
// start: a workaround for a bug in the 64 bit versions of CoCoA 3-0-4\n\
...
// end: a workaround for a bug in the 64 bit versions of CoCoA 3-0-4\n\
\n\n",
...
##
InstallGlobalFunction( InitializeCoCoAMacros,
  function( stream )
    local v;
    ...
    return InitializeMacros( CoCoAMacros, stream );
...
##
InstallGlobalFunction( RingForHomalgInCoCoA,
  function( arg )
    ...
    Add( ar, TheTypeHomalgExternalRingObjectInCoCoA );
    
    if nargs > 1 then
        Append( ar, arg{[ 2 .. nargs ]} );
    fi;
    
    ar := [ ar, TheTypeHomalgExternalRingInCoCoA ];
    
    Add( ar, "HOMALG_IO_CoCoA" );
...
##
InstallGlobalFunction( HomalgRingOfIntegersInCoCoA,
  function( arg )
    ...
    if nargs > 0 and IsInt( arg[1] ) and arg[1] <> 0 then
        ...
        if nargs > 1 and IsPosInt( arg[1] ) then
            ...
            if d > 1 then
                ...
                R := CallFuncList( HomalgRingOfIntegersInCoCoA, arg );
    ...
    if nargs > 0 and IsString( arg[1] ) then
        ...
        r := CallFuncList( HomalgRingOfIntegersInCoCoA, Concatenation( [ c ], arg ) );
    ...
    if IsBound( r ) then
        ## R will be defined in the same instance of CoCoA as r
        Add( R, r );
    fi;
    ...
    R := CallFuncList( RingForHomalgInCoCoA, R );
...
##
InstallGlobalFunction( HomalgFieldOfRationalsInCoCoA,
  function( arg )
    ...
    if nargs > 0 and IsString( arg[1] ) then
        ...
        Q := CallFuncList( HomalgFieldOfRationalsInCoCoA, arg );
    ...
    if IsBound( Q ) then
        ## R will be defined in the same instance of CoCoA as Q
        Add( R, Q );
    fi;
...
InstallMethod( PolynomialRing,
        "for homalg rings in CoCoA",
        [ IsHomalgExternalRingInCoCoARep, IsList ],
  ...
  function( R, indets )
    ...
    if HasIsIntegersForHomalg( r ) and IsIntegersForHomalg( r ) then
        ext_obj := homalgSendBlocking( [ "(integer", param, "),(", var, "),dp" ], [ "ring" ], TheTypeHomalgExternalRingObjectInCoCoA, properties, R, HOMALG_IO.Pictograms.CreateHomalgRing );
    else
        ext_obj := homalgSendBlocking( [ "(", Characteristic( R ), param, "),(", var, "),dp" ], [ "ring" ], TheTypeHomalgExternalRingObjectInCoCoA, properties, R, HOMALG_IO.Pictograms.CreateHomalgRing );
    fi;
    
    ## this must precede CreateHomalgExternalRing as otherwise
    ## the definition of 0,1,-1 would precede "minpoly=";
    ## causing an error in the new CoCoA
    ...
    S := CreateHomalgExternalRing( ext_obj, TheTypeHomalgExternalRingInCoCoA );
...
InstallMethod( RingOfDerivations,
  ...
  function( R, indets )
    ...
    if ( not ( IsBound( HOMALG_IO.show_banners ) and HOMALG_IO.show_banners = false )
        ...
        Print( display_color, "\
                     CoCoA::PLURAL\n\
The CoCoA Subsystem for Non-commutative Polynomial Computations\n\
...
================================================================\n" );
    ...
    if HasIsIntegersForHomalg( r ) and IsIntegersForHomalg( r ) then
        if base <> "" then
            ext_obj := homalgSendBlocking( [ "(integer", param,  "),(", base, var, der, "),(dp(", Length( base ), "),dp)" ], [ "ring" ], TheTypeHomalgExternalRingObjectInCoCoA, R, HOMALG_IO.Pictograms.CreateHomalgRing );
        else
            ext_obj := homalgSendBlocking( [ "(integer", param,  "),(", var, der, "),dp" ], [ "ring" ], TheTypeHomalgExternalRingObjectInCoCoA, R, HOMALG_IO.Pictograms.CreateHomalgRing );
        fi;
    else
        if base <> "" then
    ...
    if base <> "" then
        ...
        ext_obj := homalgSendBlocking( [ "nc_algebra(1,@M)" ], [ "def" ], TheTypeHomalgExternalRingObjectInCoCoA, ext_obj, HOMALG_IO.Pictograms.CreateHomalgRing );
    else
        ext_obj := homalgSendBlocking( [ "Weyl()" ], [ "def" ], TheTypeHomalgExternalRingObjectInCoCoA, ext_obj, HOMALG_IO.Pictograms.CreateHomalgRing );
    fi;
...
InstallMethod( RingOfDerivations,
        "for homalg rings in CoCoA",
        [ IsHomalgExternalRingInCoCoARep, IsList, IsList ],
...
================================================================\n" );
    ...
    ## todo: this creates a block ordering with a new "dp"-block
    if HasIsIntegersForHomalg( r ) and IsIntegersForHomalg( r ) then
        ext_obj := homalgSendBlocking( [ "(integer", param,  "),(", var, der, "),wp(", weights, ")" ], [ "ring" ], TheTypeHomalgExternalRingObjectInCoCoA, R, HOMALG_IO.Pictograms.CreateHomalgRing );
    else
...
InstallMethod( ExteriorRing,
        "for homalg rings in CoCoA",
        [ IsHomalgExternalRingInCoCoARep, IsHomalgExternalRingInCoCoARep, IsHomalgExternalRingInCoCoARep, IsList ],
  ...
  function( R, Coeff, Base, indets )
    ...
    if ( not ( IsBound( HOMALG_IO.show_banners ) and HOMALG_IO.show_banners = false )
        ...
        Print( display_color, "\
                     CoCoA::SCA\n\
The CoCoA Subsystem for Super-Commutative Algebras\n\
...
================================================================\n" );
    ...
    ext_obj := homalgSendBlocking( [ "superCommutative_ForHomalg(", Length( comm ) + 1, ");" ], [ "def" ], TheTypeHomalgExternalRingObjectInCoCoA, ext_obj, HOMALG_IO.Pictograms.CreateHomalgRing );
...
InstallMethod( AddRationalParameters,
        "for CoCoA rings",
        [ IsHomalgExternalRingInCoCoARep and IsFieldForHomalg, IsList ],
  ...
  function( R, param )
    ...
    if c = 0 then
        return HomalgFieldOfRationalsInCoCoA( par, R );
    fi;
    
    return HomalgRingOfIntegersInCoCoA( c, par, R );
...
InstallMethod( AddRationalParameters,
        "for CoCoA rings",
        [ IsHomalgExternalRingInCoCoARep and IsFreePolynomialRing, IsList ],
  ...
  function( R, param )
    ...
    ## TODO: take care of the rest
    if c = 0 then
        return HomalgFieldOfRationalsInCoCoA( par, r ) * indets;
    fi;
    
    return HomalgRingOfIntegersInCoCoA( c, par, r ) * indets;
    
end );

##
InstallMethod( SetMatElm,
        "for homalg external matrices in CoCoA",
        [ IsHomalgExternalMatrixRep and IsMutable, IsPosInt, IsPosInt, IsString, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( AddToMatElm,
        "for homalg external matrices in CoCoA",
        [ IsHomalgExternalMatrixRep and IsMutable, IsPosInt, IsPosInt, IsHomalgExternalRingElementRep, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( CreateHomalgMatrixFromString,
        "constructor for homalg external matrices in CoCoA",
        [ IsString, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( CreateHomalgMatrixFromString,
        "constructor for homalg external matrices in CoCoA",
        [ IsString, IsInt, IsInt, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( MatElmAsString,
        "for homalg external matrices in CoCoA",
        [ IsHomalgExternalMatrixRep, IsPosInt, IsPosInt, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( GetListListOfHomalgMatrixAsString,
  ...
  function( M, R )
    ...
    command := [
                ...
                v, "m=", M, "[1..", NrColumns( M ), ",i]; ",	## matrices are saved transposed in CoCoA
                "if(i!=1){", v, "s=", v, "s+\",\";}; ",
                v, "s=", v, "s+\"[\"+string(", v, "m)+\"]\";}; ",
                v, "s=", v, "s+\"]\"; kill ", v, "m"
                ];
...
InstallMethod( SaveHomalgMatrixToFile,
        "for homalg external matrices in CoCoA",
        [ IsString, IsHomalgMatrix, IsHomalgExternalRingInCoCoARep ],
...
InstallMethod( LoadHomalgMatrixFromFile,
        "for homalg external rings in CoCoA",
        [ IsString, IsInt, IsInt, IsHomalgExternalRingInCoCoARep ],
  ...
  function( filename, r, c, R )
    ...
    #read the file with GAP and parse it for better CoCoA reading:
    ...
    fname := Concatenation( filename, "-CoCoA" );
    ...
    if mode = "ListList" then
        ...
        command := [
                    ...
                    M, "=transpose(", M, "); ",	## matrices are saved transposed in CoCoA
                    v, "s=\"\""
                    ];
...
InstallMethod( Display,
  ...
  function( o )
    ...
    if IsHomalgExternalRingInCoCoARep( HomalgRing( o ) ) then
...
InstallMethod( DisplayRing,
        "for homalg rings in CoCoA",
        [ IsHomalgExternalRingInCoCoARep ], 1,
